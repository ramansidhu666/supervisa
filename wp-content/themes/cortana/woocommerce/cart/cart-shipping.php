...
<tr class="shipping">
	<th><?php
		if ( $show_package_details ) {
			...
			echo esc_html__( 'Shipping', 'woocommerce' );
		}
		?></th>
	<td>
		...
		<?php elseif ( !WC()->customer->get_shipping_state() || !WC()->customer->get_shipping_postcode() ) : ?>
			...
			<?php if ( is_cart() && get_option( 'woocommerce_enable_shipping_calc' ) === 'yes' ) : ?>
				...
				<p><?php echo esc_html__( 'Please use the shipping calculator to see available shipping methods.', 'woocommerce' ); ?></p>

			<?php elseif ( is_cart() ) : ?>

				<p><?php echo esc_html__( 'Please continue to the checkout and enter your full address to see if there are any available shipping methods.', 'woocommerce' ); ?></p>

			<?php else : ?>

				<p><?php echo esc_html__( 'Please fill in your details to see available shipping methods.', 'woocommerce' ); ?></p>
