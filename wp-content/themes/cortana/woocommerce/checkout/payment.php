...
<div id="payment" class="woocommerce-checkout-payment">
	<h3 id="checkout-payment_heading"><?php echo esc_html__( 'Payment Method', 'cortana' ) ?></h3>
	...
	<div class="form-row place-order">
		...
		<?php if ( wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) : ?>
			<p class="form-row terms">
				<label for="terms" class="checkbox"><?php printf( esc_html__( 'I&rsquo;ve read and accept the <a href="%s" target="_blank">terms &amp; conditions</a>', 'woocommerce' ), esc_url( wc_get_page_permalink( 'terms' ) ) ); ?></label>
