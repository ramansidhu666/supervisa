...
if ( !in_array( $layout_style, array( 'full', 'container', 'container-fluid' ) ) ) {
	$layout_style = g5plus_get_post_meta( get_the_ID(), 'g5plus_page_layout', true );
...
if ( !in_array( $sidebar, array( 'none', 'left', 'right', 'both' ) ) ) {
	$sidebar = g5plus_get_post_meta( get_the_ID(), 'g5plus_page_sidebar', true );
...
$left_sidebar = g5plus_get_post_meta( get_the_ID(), 'g5plus_page_left_sidebar', true );
if ( ( $left_sidebar === '' ) || ( $left_sidebar == '-1' ) ) {
	$left_sidebar = $g5plus_options['single_product_left_sidebar'];
}

$right_sidebar = g5plus_get_post_meta( get_the_ID(), 'g5plus_page_right_sidebar', true );
...
if ( !in_array( $sidebar_width, array( 'small', 'large' ) ) ) {
	$sidebar_width = g5plus_get_post_meta( get_the_ID(), 'g5plus_sidebar_width', true );
