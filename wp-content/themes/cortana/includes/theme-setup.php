...
if ( !function_exists( 'g5plus_theme_setup' ) ) {
	function g5plus_theme_setup() {
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary Menu', 'cortana' )
		) );
		...
		load_theme_textdomain( 'cortana', $language_path );

		// Apply filter do_shortcode
		add_filter( 'g5plus_do_shortcode', 'do_shortcode' );
		add_filter( 'widget_text', 'do_shortcode' );
		add_filter( 'widget_content', 'do_shortcode' );
		add_filter( 'header_customize_custom_text', 'do_shortcode' );
		...
		$g5plus_image_size = array(
			...
			'blog-classic-sidebar' => array(
				'width'  => 870,
				'height' => 480
			),
			'blog-thumbnail'       => array(
				'width'  => 370,
				'height' => 220
			),
		);
