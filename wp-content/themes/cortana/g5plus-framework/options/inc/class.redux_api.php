    ...
    if ( ! class_exists( 'Redux' ) ) {
        ...
        class Redux {
            ...
            public static function  getFileVersion( $file, $size = 8192 ) {
                ...
                $fp = call_user_func('fopen', $file, 'r' );

                // Pull only the first 8kiB of the file in.
                $file_data = call_user_func('fread', $fp, $size );

                // PHP will close file handle, but we are good citizens.
                call_user_func('fclose', $fp );
            ...
            public static function setExtensions( $opt_name, $path ) {
                if ( is_dir( $path ) ) {
                    ...
                    $folder = str_replace( '.php', '', wp_basename( $path ) );
                    ...
                    $name = explode( 'extension_', wp_basename( $path ) );
            ...
            public static function getExtensions( $opt_name = "", $key = "" ) {
                ...
                if ( empty( $opt_name ) ) {
                    ...
                    foreach ( self::$uses_extensions[ $opt_name ] as $extension ) {
                        ...
                        $name                             = str_replace( '.php', '', wp_basename( $extension ) );
