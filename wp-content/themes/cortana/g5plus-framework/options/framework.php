...
// Fix for the GT3 page builder: http://www.gt3themes.com/wordpress-gt3-page-builder-plugin/
    ...
    if ( ! class_exists( 'ReduxFrameworkInstances' ) ) {
        // Instance Container
        require_once(get_template_directory() . '/g5plus-framework/options/inc/class.redux_instances.php');
        require_once(get_template_directory() . '/g5plus-framework/options/inc/lib.redux_instances.php');
    }
...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        // Redux API class  :)
        require_once(get_template_directory() . '/g5plus-framework/options/inc/class.redux_api.php');

        // General helper functions
        require_once(get_template_directory() . '/g5plus-framework/options/inc/class.redux_helpers.php');

        // General functions
        require_once(get_template_directory() . '/g5plus-framework/options/inc/class.redux_functions.php');
        require_once(get_template_directory() . '/g5plus-framework/options/inc/class.p.php');

        require_once(get_template_directory() . '/g5plus-framework/options/inc/class.redux_filesystem.php');

        // ThemeCheck checks
        require_once(get_template_directory() . '/g5plus-framework/options/inc/class.redux_themecheck.php');
        ...
        class ReduxFramework {
            ...
            public static function init() {
                $dir = Redux_Helpers::cleanFilePath( get_template_directory() . '/g5plus-framework/options' );
...
// get_instance()
            ...
            private function _tracking() {
                require_once(get_template_directory() . '/g5plus-framework/options/inc/tracking.php');
...
// _register_settings()
            ...
            private function _register_extensions() {
                $path    = get_template_directory() . '/g5plus-framework/options/inc/extensions/';
...
//                }
            ...
            public function ajax_save() {
                ...
                if ($is_generate_less_to_css) {
                    ...
                    require_once get_template_directory() . '/g5plus-framework/core/generate-less.php';
