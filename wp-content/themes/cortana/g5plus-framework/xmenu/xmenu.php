...
final class XMenu {
	...
	private function define_constants(){
		...
		// Plugin Folder URL
		if( ! defined( 'XMENU_URL' ) ) {define( 'XMENU_URL',  get_template_directory_uri()  . '/g5plus-framework/xmenu/' );}
		if( ! defined( 'XMENU_DIR' ) ){define( 'XMENU_DIR', get_template_directory()  . '/g5plus-framework/xmenu/' );}
	...
	private function includes() {
		require_once get_template_directory() . '/g5plus-framework/xmenu/inc/global.php';
		require_once get_template_directory() . '/g5plus-framework/xmenu/inc/toolbar.php';
		require_once get_template_directory() . '/g5plus-framework/xmenu/inc/menu-item.php';
		require_once get_template_directory() . '/g5plus-framework/xmenu/inc/functions.php';
		require_once get_template_directory() . '/g5plus-framework/xmenu/inc/XMenuWalker.class.php';
		require_once get_template_directory() . '/g5plus-framework/xmenu/admin/admin.php';
	}
