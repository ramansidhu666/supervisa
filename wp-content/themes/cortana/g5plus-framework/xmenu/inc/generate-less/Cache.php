...
require_once(get_template_directory()  . '/g5plus-framework/xmenu/inc/generate-less/Version.php');
...
class Less_Cache{
	...
	public static function Cache( &$less_files, $parser_options = array() ){
		...
		$file = get_template_directory()  . '/g5plus-framework/xmenu/inc/generate-less/Less.php';
