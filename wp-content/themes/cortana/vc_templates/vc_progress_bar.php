<?php
$layout_style = $output = $title = $values = $units = $bgcolor = $custombgcolor = $options = $el_class = '';
...
$output    = '<div class="cortana-h-progress-bar ' . esc_attr( $layout_style ) . ' ' . $css_class . '">';
...
$output .= '</div>' . $this->endBlockComment( 'progress_bar' ) . "\n";
