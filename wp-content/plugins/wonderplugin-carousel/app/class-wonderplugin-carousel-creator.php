					...
					<div class="wonderplugin-carousel-options-tabs" id="wonderplugin-carousel-options-tabs">
						...
						<div class="wonderplugin-carousel-options-tab wonderplugin-carousel-options-tab-selected">
							...
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									<th>Width / Height</th>
									<td><label><input name="wonderplugin-carousel-width" type="text" id="wonderplugin-carousel-width" value="300" class="small-text" /> / <input name="wonderplugin-carousel-height" type="text" id="wonderplugin-carousel-height" value="300" class="small-text" /></label>
									<p><label><input name='wonderplugin-carousel-fixaspectratio' type='checkbox' id='wonderplugin-carousel-fixaspectratio'  /> Use the aspect ratio for all thumbnail images</label>
						...
						<div class="wonderplugin-carousel-options-tab">
							<table class="wonderplugin-form-table-noborder">
								<tr>
									...
									<br><label><input name="wonderplugin-carousel-lightboxcloseonoverlay" type="checkbox" id="wonderplugin-carousel-lightboxcloseonoverlay" /> Close the lightbox when clicking on the overlay background</label>
									</td>
								</tr>
								<tr valign="top">
									...
									<br>Slideshow interval (ms): <input name="wonderplugin-carousel-lightboxslideinterval" type="number" min=0 id="wonderplugin-carousel-lightboxslideinterval" value="5000" class="small-text" />
								...
								<tr valign="top">
									...
									Opacity: <input name="wonderplugin-carousel-lightboxoverlayopacity" type="number" min=0 max=1 step="0.1" id="wonderplugin-carousel-lightboxoverlayopacity" value="0.9" class="small-text" /></td>
								</tr>
								...
								<tr valign="top">
									...
									<td>Radius (px): <input name="wonderplugin-carousel-lightboxborderradius" type="number" min=0 id="wonderplugin-carousel-lightboxborderradius" value="0" class="small-text" />
									Size (px): <input name="wonderplugin-carousel-lightboxbordersize" type="number" min=0 id="wonderplugin-carousel-lightboxbordersize" value="8" class="small-text" />
									</td>
								</tr>
