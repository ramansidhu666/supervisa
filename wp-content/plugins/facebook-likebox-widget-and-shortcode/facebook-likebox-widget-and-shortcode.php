...
Description: A WordPress Social Plugin To Show Facebook Likebox
Version: 0.1.9
Author: A WP Life
Author URI: http://awplife.com/
License: GPLv2 or later
Text Domain: fblike_txt_dm
...
class AWPLIFW_FB_Widget_Shotcode extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'Facebook Likebox Widget', 'fblike_txt_dm' ), // Name
			array( 'description' => __( 'A Social Widget For Facebook Likebox', 'fblike_txt_dm' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		<p style="display: none;">WordPress Facebook Likebox Plugin Develop & Designed by <a href="http://awplife.com/">A WP Life Team</a></p>
		<?php
	...
	public function form( $instance ) {
		...
		?>
		<p>
		<label for="<?php echo $this->get_field_id( 'w_title' ); ?>"><?php _e( 'Widget Title' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'w_title' ); ?>" name="<?php echo $this->get_field_name( 'w_title' ); ?>" type="text" value="<?php echo esc_attr( $w_title ); ?>" placeholder="Type Widget Title">
		</p>
		
		<p>
		<label for="<?php echo $this->get_field_id( 'app_id' ); ?>"><?php _e( 'Facebook Application ID' ); ?></label> &nbsp;  (<a href="http://awplife.com/create-facebook-application-id/" target="_new">Create New Own Application ID</a>)
		<input class="widefat" id="<?php echo $this->get_field_id( 'app_id' ); ?>" name="<?php echo $this->get_field_name( 'app_id' ); ?>" type="text" value="<?php echo esc_attr( $app_id ); ?>" placeholder="Enter Facebook Application ID Here">
		</p>
		
		<p>
		<label for="<?php echo $this->get_field_id( 'fb_page_url' ); ?>"><?php _e( 'Your FaceBook Page URL' ); ?></label> 
		<input class="widefat" id="<?php echo $this->get_field_id( 'fb_page_url' ); ?>" name="<?php echo $this->get_field_name( 'fb_page_url' ); ?>" type="text" value="<?php echo esc_attr( $fb_page_url ); ?>" placeholder="Enter FaceBook Application ID Here">
		</p>
		
		<p>
		<label for="<?php echo $this->get_field_id( 'w_auto_width' ); ?>"><?php _e( 'Auto Widget Width' ); ?></label><br>
		<input class="widefat" id="<?php echo $this->get_field_id( 'w_auto_width' ); ?>" name="<?php echo $this->get_field_name( 'w_auto_width' ); ?>" <?php if($w_auto_width == 'true') echo "checked=checked" ?> type="radio" value="true"> Yes &nbsp;&nbsp;
		<input class="widefat" id="<?php echo $this->get_field_id( 'w_auto_width' ); ?>" name="<?php echo $this->get_field_name( 'w_auto_width' ); ?>" <?php if($w_auto_width == 'false') echo "checked=checked" ?> type="radio" value="false"> No
		</p>
		
		<p>
		<label for="<?php echo $this->get_field_id( 'w_width' ); ?>"><?php _e( 'Custom Widget Width' ); ?></label> 
		<input class="widefat" id="<?php echo $this->get_field_id( 'w_width' ); ?>" name="<?php echo $this->get_field_name( 'w_width' ); ?>" type="text" value="<?php echo esc_attr( $w_width ); ?>" placeholder="(Min Width: 180 - Max Width: 500)">
		</p>
		
		<p>
		<label for="<?php echo $this->get_field_id( 'w_height' ); ?>"><?php _e( 'Custom Widget Height' ); ?></label> 
		<input class="widefat" id="<?php echo $this->get_field_id( 'w_height' ); ?>" name="<?php echo $this->get_field_name( 'w_height' ); ?>" type="text" value="<?php echo esc_attr( $w_height ); ?>" placeholder="(Minimium Height: 70)">
		</p>
				
		<p>
		<label for="<?php echo $this->get_field_id( 'cover_photo' ); ?>"><?php _e( 'Show Cover Photo' ); ?></label><br>
		<input class="widefat" id="<?php echo $this->get_field_id( 'cover_photo' ); ?>" name="<?php echo $this->get_field_name( 'cover_photo' ); ?>" <?php if($cover_photo == 'false') echo "checked=checked" ?> type="radio" value="false"> Yes &nbsp;&nbsp;
		<input class="widefat" id="<?php echo $this->get_field_id( 'cover_photo' ); ?>" name="<?php echo $this->get_field_name( 'cover_photo' ); ?>" <?php if($cover_photo == 'true') echo "checked=checked" ?> type="radio" value="true"> No
		</p>
		
		<p>
		<label for="<?php echo $this->get_field_id( 'header_size' ); ?>"><?php _e( 'Widget Header Size' ); ?></label><br>
		<input class="widefat" id="<?php echo $this->get_field_id( 'header_size' ); ?>" name="<?php echo $this->get_field_name( 'header_size' ); ?>" <?php if($header_size == 'true') echo "checked=checked" ?> type="radio" value="true"> Small &nbsp;&nbsp;
		<input class="widefat" id="<?php echo $this->get_field_id( 'header_size' ); ?>" name="<?php echo $this->get_field_name( 'header_size' ); ?>" <?php if($header_size == 'false') echo "checked=checked" ?> type="radio" value="false"> Large
		</p>
		
		<p>
		<label for="<?php echo $this->get_field_id( 'show_fans' ); ?>"><?php _e( 'Show Friends' ); ?></label><br>
		<input class="widefat" id="<?php echo $this->get_field_id( 'show_fans' ); ?>" name="<?php echo $this->get_field_name( 'show_fans' ); ?>" <?php if($show_fans == 'true') echo "checked=checked" ?> type="radio" value="true"> Yes &nbsp;&nbsp;
		<input class="widefat" id="<?php echo $this->get_field_id( 'show_fans' ); ?>" name="<?php echo $this->get_field_name( 'show_fans' ); ?>" <?php if($show_fans == 'false') echo "checked=checked" ?> type="radio" value="false"> No
		</p>
		
		<p>
		<label for="<?php echo $this->get_field_id( 'show_post' ); ?>"><?php _e( 'Show Page Posts' ); ?></label><br>
		<input class="widefat" id="<?php echo $this->get_field_id( 'show_post' ); ?>" name="<?php echo $this->get_field_name( 'show_post' ); ?>" <?php if($show_post == 'true') echo "checked=checked" ?> type="radio" value="true"> Yes &nbsp;&nbsp;
		<input class="widefat" id="<?php echo $this->get_field_id( 'show_post' ); ?>" name="<?php echo $this->get_field_name( 'show_post' ); ?>" <?php if($show_post == 'false') echo "checked=checked" ?> type="radio" value="false"> No
		</p>
