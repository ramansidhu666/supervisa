...
class G5Plus_Widget_Twitter extends G5Plus_Widget {
	public function __construct() {
		...
		$this->widget_description = __( "Display your latest tweets", 'cortana' );
		$this->widget_id          = 'g5plus-twitter';
		$this->widget_name        = __( 'G5Plus: Twitter', 'cortana' );
		$this->settings           = array(
			'title'               => array(
				'type'  => 'text',
				'std'   => '',
			...
			'user_name'           => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'User Name', 'cortana' )
			),
			'consumer_key'        => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Consumer Key', 'cortana' )
			),
			'consumer_secret'     => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Consumer Secret', 'cortana' )
			),
			'access_token'        => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Access Token', 'cortana' )
			),
			'access_token_secret' => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Access Token Secret', 'cortana' )
			),
			'time_to_store'       => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Time To Store', 'cortana' )
			),
			'total_feed'          => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Total Feed', 'cortana' )
			),
		);
		parent::__construct();
	}
