...
class G5Plus_Widget_Posts extends G5Plus_Widget {
	public function __construct() {
		...
		$this->widget_description = __( "Posts widget", 'cortana' );
		$this->widget_id          = 'g5plus-posts';
		$this->widget_name        = __( 'G5Plus: Posts', 'cortana' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => '',
			...
			'source' => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => __( 'Source', 'cortana' ),
				'options' => array(
					'random'  => __( 'Random', 'cortana' ),
					'popular' => __( 'Popular', 'cortana' ),
					'recent'  => __( 'Recent', 'cortana' ),
					'oldest'  => __( 'Oldest', 'cortana' )
				)
			),
			'number' => array(
				'type'  => 'number',
				'std'   => '5',
				'label' => __( 'Number of posts to show', 'cortana' ),
			)
		);
		parent::__construct();
	}
